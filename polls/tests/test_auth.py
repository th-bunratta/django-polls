...
class AuthTest(TestCase):
    ...
    def setUp(self):
        ...
        self.c1 = Choice.objects.create(choice_text="First Choice", choice_question=self.q1)
        self.c2 = Choice.objects.create(choice_text="Second Choice", choice_question=self.q1)
        self.c3 = Choice.objects.create(choice_text="Third Choice", choice_question=self.q1)
        # a user who can vote
    ...
    def test_vote_requires_auth_user(self):
        ...
        expect_url = reverse('accounts:login') + '?next=' + vote_url
